...
class Product(models.Model):
    ...
    @api.model
    def sync_not_reload(self, client_version=0, _fields=None, pricelist_id=0):
        ...
        records = self.env['product.product'].with_context(display_default_code=False, pricelist=pricelist_id) \
