...
odoo.define('pos_speed_up.change_detector', function (require) {
    ...
    var ChangeDetectorWidget = chrome.StatusWidget.extend({
        ...
        set_status: function (status, msg) {
            ...
            this.$('.jane_' + status).addClass('oe_hidden');
            ...
            this.$('.jane_msg').addClass('oe_hidden');
        },
        start: function () {
            var self = this;
        ...
        p_sync_not_reload: function (server_version) {
            ...
            new Model('product.index').call('sync_not_reload', [client_version, model.fields, self.pos.pricelist.id]).then(function (res) {
        ...
        c_sync_not_reload: function (server_version) {
            ...
            new Model('customer.index').call('sync_not_reload', [client_version, model.fields]).then(function (res) {
